...
var ratesItems = document.querySelectorAll('.rates__item');
var mainButton = document.querySelector(".main__button");

/* === CHOOSE THE RATE === */
rates.addEventListener('click', function (e) {
  var rate = e.target.closest('.rates__item');
  if (rate) {
    ratesItems.forEach(function (item) {
      return item.classList.add('blurred');
    });
